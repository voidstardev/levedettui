...
do
	...
	LibFrame["1"]["Name"] = [[Milans Hub Library v2]]
		...
		task.spawn(function()
			...
			if options.KeySystem then
				...
				do
					...
					KeySystem["a4"]["PlaceholderText"] = [[Kulcs]]
					...
					KeySystem["a6"]["Text"] = [[Prémium Kulcs]]
					...
					KeySystem["a9"]["Text"] = [[Ha megvásároltad, írd be ide a megfelelő kulcsot!]]
